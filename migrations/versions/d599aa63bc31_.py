...
Revision ID: d599aa63bc31
Revises: 
Create Date: 2019-07-28 21:09:07.365653
...
def upgrade():
    ...
    op.create_table('block_class_schedule_association',
...
def downgrade():
    ...
    op.drop_table('block_class_schedule_association')
